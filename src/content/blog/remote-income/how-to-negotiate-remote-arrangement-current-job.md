---
title: "How to Negotiate a Remote Arrangement at Your Current Job"
description: "A practical playbook for negotiating permanent remote work at your current job: what to say, when to say it, and how to protect the arrangement."
pubDate: 2026-05-22
author: "ExpatBuildr"
...
primaryKeyword: "how to negotiate a remote arrangement at your current job"
secondaryKeywords:
  - "how to ask your boss to work from home permanently"
  - "negotiating remote work after RTO mandate"
  - "how to get remote work approved"
  - "making the case for permanent remote work"
...
A one-page summary you can reference in the conversation (not hand over, just reference). Something that lets you say: "In the last eight months when I've worked from home on Tuesdays and Thursdays, I've closed X accounts, delivered Y projects on time, and received this feedback from the team. The output data doesn't show a difference between my office days and remote days."
...
- The job market for your role is active, meaning you could realistically find a new remote role within 60–90 days if this fails
...
1. Lowers the psychological stakes for your manager, since they're not making a permanent policy decision
...
4. Makes it easy to say yes, since there's a built-in exit if things go wrong, which reduces your manager's risk
...
The [remote income hub at ExpatBuildr](/blog/remote-income) covers both paths: staying and optimizing, or leaving and landing somewhere better. If you do stay and want to turn this arrangement into a raise, [How to Ask for a Raise When You Work Remotely](/blog/remote-income/how-to-ask-for-a-raise-when-you-work-remotely) covers the exact conversation framework.

And if you're thinking beyond just remote and toward building real location independence, the [ArbJobs framework](/geo-arbitrage/arbjobs) is the next read.
