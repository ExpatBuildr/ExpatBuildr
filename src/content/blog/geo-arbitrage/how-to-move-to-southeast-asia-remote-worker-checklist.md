---
title: "How to Move to Southeast Asia as a Remote Worker: The Full Checklist"
description: "Everything you need to move to Southeast Asia as a remote worker — visas, banking, housing, health insurance, and the mistakes most people make on the way."
pubDate: 2026-05-25
...
primaryKeyword: "how to move to Southeast Asia as a remote worker"
...
- **Philippines:** US citizens get 30 days visa-free on arrival, extendable to 59 days at the Bureau of Immigration. Long-stay options include the SRRV (Special Resident Retiree's Visa) or the 13A for those with Filipino family. The Philippines does not yet have a formal digital nomad visa — most remote workers extend tourist visas monthly or quarterly.
- **Thailand:** US citizens get 60 days visa-free. The Thailand LTR (Long-Term Resident) visa is now available for remote workers earning above $80,000 per year — it gives 10-year residency and a work permit. The Tourist visa with extensions is the most common path for shorter stays.
- **Vietnam:** US citizens get 45 days visa-free. The E-visa is available for 90 days single entry. Long-stay options are limited — most remote workers use visa runs or the business visa route.
...
Check the official immigration website for your target country before relying on any third-party summary including this one — visa rules change.
...
For more on the specific neighborhoods worth considering in Cebu, read [Best Neighborhoods for Remote Workers in Cebu City: The Full Breakdown](/blog/geo-arbitrage/best-neighborhoods-remote-workers-cebu-city).

---

## Internet: Your Most Important Infrastructure

Everything else about SEA is flexible. Internet is not. Before you sign any lease, test the internet in the unit. Not the building's WiFi — the actual connection in the apartment you are considering.
...
In the Philippines, PLDT and Globe are the two major fiber providers. Coverage and reliability vary significantly by building and neighborhood. Always ask the landlord or building admin which provider services the unit and what the actual speeds are — not the package speed but the real-world speed.
...
<div class="video-embed">
  <iframe
    width="100%"
    height="480"
    src="https://www.youtube.com/embed/zkQ9C-kUMts"
    title="I Lost $21,000 Moving to the Philippines"
    frameborder="0"
...
Consult a US expat tax specialist — not a general CPA — before your first full tax year abroad. The setup cost is worth it. Mistakes in this area are expensive to correct. For the full breakdown of how banking and taxes work together, read [Banking, Taxes, and Money for US Remote Workers Living Abroad](/blog/geo-arbitrage/banking-taxes-money-us-remote-workers-living-abroad).
...
- [ ] Carry 3 to 6 months of any prescription medications — local availability varies
...
Moving to Southeast Asia as a remote worker is logistically straightforward if you prepare in sequence: visa first, banking second, housing third, health insurance fourth, tax fourth. The mistakes that cost people the most — expensive housing they never should have committed to, medical bills they are not covered for, tax penalties from not filing correctly — all come from skipping preparation and assuming it will work out on the ground.

It works out far better when you arrive with the infrastructure already in place.

To understand exactly how your income translates into purchasing power in Southeast Asia before you make the move, use the [Geo-Arbitrage Income Calculator](/shop) — it maps your USD earnings against real cost of living across SEA cities so you know your numbers before you go.

For more on the geo-arbitrage strategy behind the move, visit the [Geo-Arbitrage hub](/blog/geo-arbitrage).
