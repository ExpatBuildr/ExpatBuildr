...
For the geo-arbitrage model both paths build on, read [What Is an Expat Founder and Why It Is Different From Being a Digital Nomad](/blog/geo-arbitrage/what-is-an-expat-founder).

For the financial model behind both approaches, use the [Geo-Arbitrage Income Calculator](/shop).
...
A remote employee earning $90,000 per year living in Cebu on $18,000 per year is saving $72,000 annually — a 80 percent savings rate that would be nearly impossible to achieve in the US on the same income. In 5 years at that rate with reasonable investment returns, they have built a $400,000 to $500,000 financial position from a $90,000 income that in the US would have produced a fraction of that.
...
**The ceiling:** The remote employee's income ceiling is defined by their employer. Raises are incremental. Promotions are available but bounded. The income trajectory is linear at best — 3 to 5 percent per year in a good year, flat or negative in a difficult one. The geo-arbitrage advantage amplifies whatever income they have but does not change the fundamental trajectory.
...
The expat founder is playing a different game. Instead of amplifying an existing income through the geo-arbitrage cost structure, they are using the geo-arbitrage cost structure to fund the building of an asset — a business, a content platform, a newsletter, a software product — that generates equity value in addition to income.
...
The distinction between the two games is worth understanding clearly. Most founders who make the transition successfully do it deliberately rather than accidentally — they know which game they are playing at each stage and make decisions accordingly.
