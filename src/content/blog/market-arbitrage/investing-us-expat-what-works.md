...
primaryKeyword: "investing as US expat what works"
...
This is not investment advice — consult a qualified financial advisor familiar with US expat situations before making investment decisions. This guide covers the framework.

For the money stack foundation this investment layer builds on, read [The Expat Founder Money Stack: Banking, Entity, and Tax Setup](/blog/market-arbitrage/expat-founder-money-stack).

Browse the [ExpatBuildr shop](/shop) for the tools and calculators that support this investing framework.
...
**The access problem:** Some US brokerages restrict account access or close accounts for US persons who update their address to a foreign country. This is a compliance decision on the broker's part, not a legal requirement. The solution is to maintain a US mailing address — a trusted family member's address, a mail forwarding service, or a virtual mailbox — and not update your brokerage account to a foreign address.
...
Given the geo-arbitrage surplus that most expat founders generate, the investment structure question is primarily about sequencing — in what order to fill which accounts and with what assets.
...
**Step 3: Taxable brokerage account.** Once the emergency fund and retirement accounts are funded, additional surplus goes into a taxable brokerage account. For most expat founders, a simple three-fund portfolio — US total market index, international developed market index (US-listed ETF to avoid PFIC), and bond index — at an asset allocation appropriate to your age and risk tolerance handles the long-term wealth building layer.

## Digital Assets as a Portfolio Component

Cryptocurrency occupies a specific role in the expat founder investment stack that is distinct from traditional investing. For founders already comfortable with digital asset volatility and who understand the tax reporting requirements (crypto is taxed as property in the US — every transaction is a taxable event), a small allocation (5 to 15 percent of investable assets) to Bitcoin or major digital assets can serve as both a speculative return driver and practical financial infrastructure.

The practical infrastructure angle: crypto enables fast, low-friction international transfers when traditional banking channels are slow or restricted. For founders running cross-border operations who occasionally need to move money quickly across jurisdictions, having a working knowledge of crypto rails has operational utility beyond the investment thesis.

The tax complexity of crypto for US expats is real and requires careful tracking. Use a tool like Koinly or CoinTracker to maintain accurate records of all transactions.
...
- IRS. (2026). *Passive Foreign Investment Companies (PFIC)*. IRS.gov.
- Charles Schwab. (2026). *International Account Access Policy*. Schwab.com.
- Interactive Brokers. (2026). *Accounts for US Expats*. InteractiveBrokers.com.
