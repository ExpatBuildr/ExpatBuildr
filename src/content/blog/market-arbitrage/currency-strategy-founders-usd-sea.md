---
title: "Currency Strategy for Founders Earning in USD and Spending in SEA"
description: "Every expat founder has a currency position whether they manage it or not. Here is the strategy that minimizes friction and maximizes purchasing power."
pubDate: 2026-06-28
author: "ExpatBuildr"
...
primaryKeyword: "currency strategy founders earning USD spending SEA"
...
For the broader money stack this currency strategy operates within, read [The Expat Founder Money Stack: Banking, Entity, and Tax Setup](/blog/market-arbitrage/expat-founder-money-stack).

For everything in the Market Arbitrage pillar in one place, visit [Market Arbitrage Links](/market-arbitrage-links).

Get [weekly market arbitrage intel](/newsletter) on currency strategy and money management delivered free.
...
**The conversion spread:** Banks apply a markup to the mid-market exchange rate — typically 2 to 4 percent above the rate you would find on Google. On a $3,000 conversion, a 3 percent spread costs $90. If you do this monthly, the annual cost is $1,080 — purely in conversion friction.
...
For practical currency timing: convert monthly amounts on a consistent schedule rather than trying to time the market. The friction saved by not watching exchange rates exceeds the gains available from rate timing for amounts at the expat founder scale. Save timing decisions for large one-time conversions — a rent payment for six months in advance, a large equipment purchase — where the absolute amount makes the rate difference meaningful.
